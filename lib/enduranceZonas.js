...
// Referências: corrida = VDOT (Daniels); ciclismo = FTP em W/kg (Coggan).
...
/**
 * FTP → nível. O correto é W/kg (Coggan): <2.5 iniciante; 2.5–3.5 intermediário;
 * ≥3.5 avançado. Sem o peso, cai num proxy por FTP absoluto (menos preciso).
 */
