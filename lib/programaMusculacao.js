...
export const VARIACOES = {
  ...
  'Supino Inclinado com Halteres':    ['Supino Inclinado com Barra', 'Supino Inclinado na Polia', 'Supino Inclinado Máquina'],
  'Crucifixo Inclinado com Halteres': ['Crucifixo Reto com Halteres', 'Crucifixo Inclinado Máquina', 'Crucifixo Inclinado na Polia'],
  ...
  // ── Deltóide ──
  'Desenvolvimento com Halteres':     ['Desenvolvimento com Barra Frontal', 'Desenvolvimento Máquina', 'Press Militar em Pé'],
  'Desenvolvimento Arnold':           ['Desenvolvimento Máquina Articulada', 'Desenvolvimento Máquina', 'Desenvolvimento com Barra Frontal'],
  ...
  // ── Tríceps ──
  'Tríceps Francês com Halter':       ['Tríceps Testa com Halteres', 'Tríceps Francês na Polia', 'Extensão de Tríceps Máquina'],
  'Tríceps na Polia com Corda':         ['Tríceps na Polia com Barra', 'Tríceps Coice Unilateral na Polia', 'Tríceps Testa com Barra W'],
  'Tríceps na Polia com Barra':         ['Tríceps na Polia com Corda', 'Tríceps Testa na Polia', 'Extensão Unilateral na Polia'],
  'Extensão Unilateral na Polia':     ['Tríceps Banco Livre', 'Tríceps Coice com Halter', 'Tríceps na Polia com Corda'],
  // ── Dorsal (recheado com os exercícios novos, posições 1-3) ──
  'Remada Curvada com Barra':         ['Remada Linear Aberta', 'Remada Articulada Aberta', 'Remada Curvada Supinada na Polia', 'Remada Cavalinho', 'Remada Serrote'],
  'Puxada Frontal com Barra':         ['Puxada Romana Aberta', 'Graviton Aberto', 'Puxada Máquina', 'Puxada Articulada', 'Pulldown com Corda', 'Barra Fixa Fechada'],
  'Remada Sentada Máquina':           ['Remada Máquina Supinada', 'Remada Linear Fechada', 'Remada Articulada Fechada', 'Remada Unilateral na Polia', 'Remada Máquina Fechada'],
  'Puxada Articulada':                ['Graviton Fechado', 'Graviton Supinado', 'Puxada Romana Fechada', 'Puxada Articulada Neutra', 'Pulldown com Barra'],
  // ── Bíceps ──
  'Rosca Direta com Barra':           ['Rosca Direta com Halteres', 'Rosca Invertida na Polia', 'Rosca Scott Hammer', 'Rosca na Polia Baixa', 'Bíceps Máquina'],
  ...
  // ── Deltóide/Trapézio ──
  'Encolhimento com Halteres':        ['Encolhimento com Barra', 'Encolhimento no Ground', 'Encolhimento no Smith'],
  // ── Abdômen/Core ──
  'Hiperextensão Lombar no Banco Romano': ['Superman Solo', 'Bird-dog'],
  // ── Quadríceps ──
  ...
  // ── Isquiotibial/Glúteo ──
  'Stiff com Barra Livre':            ['Terra Sumo Barra Livre', 'Terra Sumo no Smith', 'Stiff no Smith', 'Deadlift', 'Bom Dia no Smith'],
  ...
  'Elevação de Quadril com Barra':    ['Elevação de Quadril com Halter', 'Elevação de Quadril no Smith', 'Elevação de Quadril com Barra Livre'],
  'Elevação de Quadril Máquina':       ['Elevação de Quadril Solo', 'Elevação de Quadril Solo Unilateral', 'Glúteo 4 Apoios'],
  'Búlgaro com Halteres':             ['Búlgaro no Smith', 'Agachamento Búlgaro no Ground', 'Agachamento Búlgaro', 'Afundo no Hack Machine'],
  'Extensão de Quadril Máquina':   ['Coice de Glúteo', 'Glúteo 4 Apoios na Polia', 'Flexão de Quadril na Máquina', 'Extensão de Quadril na Polia', 'Extensão de Quadril Cruzado'],
  // ── Panturrilha ──
  'Panturrilha Em Pé na Máquina':      ['Panturrilha no Leg Press', 'Panturrilha na Smith', 'Gêmeos Sentado'],
  'Panturrilha Sentado Máquina':    ['Gêmeos Sentado', 'Panturrilha na Smith', 'Panturrilha no Leg Press'],
  'Panturrilha no Leg Press':         ['Panturrilha Em Pé na Máquina', 'Panturrilha Sentado Máquina', 'Gêmeos Sentado'],
  // ── Abdômen / Core ──
  'Abdominal na Polia':               ['Abdominal Máquina Horizontal', 'Abdominal Infra Paralelas', 'Abdominal Infra Paralelas Flexionado', 'Abdominal Máquina Total', 'Abdominal Supra'],
  'Abdominal Supra':                  ['Abdominal na Polia', 'Abdominal Oblíquo', 'Abdominal Máquina Horizontal'],
  'Prancha Frontal':                  ['Prancha Lateral', 'Bird-dog Isométrico', 'Prancha Baixa Alta Explosiva', 'Hollow Body', 'Bird-dog'],
  'Prancha Lateral':                  ['Prancha Frontal', 'Hollow Body', 'Bird-dog'],
  // ── Femininos (glúteo/posterior + braço com halter) ──
  'Cadeira Abdutora':                 ['Abdução de Quadril 45°', 'Abdução de Quadril com Mini Band', 'Cadeira Abdutora 45°', 'Cadeira Abdutora a Frente', 'Abdução de Quadril na Máquina'],
  ...
  'Elevação de Quadril com Halter':   ['Elevação de Quadril Solo', 'Elevação de Quadril Solo Unilateral', 'Elevação de Quadril no Smith'],
...
const TREINOS_H = {
  ...
  A3: { nome: 'A — Push: Peito + Ombro + Tríceps', foco: 'Peitoral · Ombro · Tríceps', ex: [
    ...
    R('Tríceps na Polia com Corda', { role: 'metabolico' }),
  ]},
  // PULL — compartilhado 3x/4x
  B: { nome: 'B — Pull: Dorsal + Bíceps', foco: 'Dorsal · Bíceps/Antebraço · Abdômen/Core', ex: [
    F('Remada Curvada com Barra'),
    H('Puxada Frontal com Barra', { reps: '8-10' }),
    H('Remada Sentada Máquina', { n: 3, reps: '10-12', pausa: '75s', role: 'pico' }),
    ...
    R('Face Pull'),
    H('Hiperextensão Lombar no Banco Romano', { n: 3, reps: '12-15', pausa: '60s' }),
  ]},
  // LEGS — compartilhado 3x/4x
  C: { nome: 'C — Pernas + Core', foco: 'Quadríceps · Isquiotibial/Glúteo · Panturrilha · Core', ex: [
  ...
  A4: { nome: 'A — Push: Peito + Tríceps', foco: 'Peitoral · Tríceps', ex: [
    F('Supino Reto com Barra'),
    H('Supino Inclinado com Halteres', { reps: '8-10' }),
    H('Crucifixo Inclinado com Halteres', { n: 3, reps: '10-12', pausa: '75s', role: 'densidade' }),
    R('Cross Over'),
    ...
    H('Tríceps na Polia com Barra', { n: 3, reps: '10-12', pausa: '60s' }),
    R('Extensão Unilateral na Polia', { role: 'metabolico' }),
  ]},
  // OMBRO — 4x (trapézio entra aqui)
  D: { nome: 'D — Deltóide/Trapézio + Panturrilha', foco: 'Deltóide/Trapézio · Panturrilha', ex: [
    ...
    H('Panturrilha Sentado Máquina', { n: 4, reps: '10-12', pausa: '60s' }),
  ...
  C5: { nome: 'C — Dorsal + Bíceps', foco: 'Dorsal · Bíceps/Antebraço · Abdômen/Core', ex: [
    F('Remada Curvada com Barra'),
    H('Puxada Frontal com Barra', { reps: '8-10' }),
    H('Remada Sentada Máquina', { n: 3, reps: '10-12', pausa: '75s', role: 'pico' }),
    R('Puxada Articulada', { role: 'densidade' }),
  ...
  D5: { nome: 'D — Isquiotibial/Glúteo + Core', foco: 'Isquiotibial/Glúteo · Panturrilha · Core', ex: [
    F('Stiff com Barra Livre'),
    H('Mesa Flexora'),
    H('Elevação de Quadril com Barra', { n: 3, reps: '10-12', pausa: '75s' }),
    R('Cadeira Flexora', { role: 'densidade' }),
    R('Extensão de Quadril Máquina', { role: 'metabolico' }),
    H('Panturrilha Sentado Máquina', { n: 3, reps: '12-15', pausa: '60s', role: 'pico' }),
    R('Abdominal na Polia', { reps: '15-20' }),
    I('Prancha Frontal'),
  ]},
  // OMBRO — 5x
  E5: { nome: 'E — Deltóide/Trapézio', foco: 'Deltóide/Trapézio', ex: [
  ...
  FC: { nome: 'C — Isquiotibial/Glúteo + Core', foco: 'Isquiotibial/Glúteo · Panturrilha · Core', ex: [
    F('Stiff com Barra Livre'),
    H('Mesa Flexora', { n: 4, reps: '8-10', pausa: '90s' }),
    H('Elevação de Quadril Máquina', { n: 3, reps: '10-12', pausa: '75s' }),
    R('Extensão de Quadril Máquina', { role: 'metabolico' }),
    H('Búlgaro com Halteres', { n: 3, reps: '10-12', pausa: '75s', role: 'pico' }),
    R('Cadeira Flexora', { role: 'densidade' }),
    H('Panturrilha Sentado Máquina', { n: 3, reps: '12-15', pausa: '60s' }),
    I('Prancha Lateral'),
  ]},
  // ── 4x/5x: superior dividido em PUXAR (B) e EMPURRAR (D) ──
  FBP: { nome: 'B — Puxar: Costas + Bíceps', foco: 'Dorsal · Bíceps/Antebraço · Deltóide posterior', ex: [
    F('Puxada Frontal com Barra'),
    H('Remada Sentada Máquina', { n: 4, reps: '8-10', pausa: '90s', role: 'pico' }),
  ...
  MB2: { nome: 'B — Full Body: Volume', foco: 'Full Body · Ênfase Volume', ex: [
    ...
    R('Elevação Lateral com Halteres', { role: 'pico' }),
    H('Remada Sentada Máquina', { n: 3, reps: '12-15', pausa: '60s', role: 'densidade' }),
    R('Cadeira Extensora', { role: 'metabolico' }),
  ...
  FB2: { nome: 'B — Full Body: Volume', foco: 'Full Body · Ênfase Posterior/Volume', ex: [
    ...
    H('Elevação de Quadril Máquina', { reps: '12-15', role: 'densidade' }),
...
// ─────────────────────────────────────────────────────────────────────────────
// Ordem crescente de frequência (2x → 5x), masculino e depois feminino — é a
// sequência que aparece na lista de programas.
...
function montarExercicio(slot, vIdx, mes, usados, excluir) {
  ...
  // Compostos pesados (slot de força) NÃO rotacionam mês a mês: ficam FIXOS
  // dentro do bloco de 3 meses, pra o aluno progredir CARGA no mesmo movimento
  // (pilar de hipertrofia — Schoenfeld/ACSM). Trocam só na virada de bloco:
  // bloco 1 (mês 1-3) = base · bloco 2 (4-6) = 1ª variação · etc. Os demais
  // slots (isoladores/auxiliares) seguem rotacionando mês a mês como antes.
  const vIdxSlot = slot.fase === 'forca' ? Math.floor((mes - 1) / 3) : vIdx;
  let nome = varEx(slot.base, vIdxSlot);
  if (invalido(nome)) {
